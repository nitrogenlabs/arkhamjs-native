...
var FluxNative = function (_EventEmitter) {
  ...
  function FluxNative() {
    ...
    if (_this._useCache) {
      _this.getSessionData('nlFlux').then(function (data) {
        _this._store = _immutable.Map.isMap(data) ? data : (0, _immutable.Map)();
      });
    }
    return _this;
  }
    ...
    value: function dispatch() {
      ...
      actions.map(function (a) {
        ...
        _this2._storeClasses.map(function (storeClass) {
          ...
          if (_this2._useCache) {
            promises.push(_this2.setSessionData('nlFlux', _this2._store));
          }
    ...
    value: function registerStore(StoreClass) {
      ...
      if (!this._storeClasses.has(name)) {
        (function () {
          ...
          // Get cached data
          if (_this3._useCache) {
            _this3.getSessionData('nlFlux').then(function (data) {
              ...
              // Save cache in session storage
              _this3.setSessionData('nlFlux', _this3._store);
            });
          }
        })();
      }
