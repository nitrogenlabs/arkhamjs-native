...
{var c=this;
this.getSessionData(this._name).then(function(d){
_immutable.Map.isMap(d)&&(
c._store=d);
...
var e=c.constructor.toString().substr(0,5);
...
if(!this._storeClasses.get(g))




if(this._storeClasses=this._storeClasses.set(g,f),this._useCache)
this.getSessionData(this._name).
then(function(h){
var j=_immutable.Map.isMap(h)?h:(0,_immutable.Map)(),


l=d._store.get(g)||j.get(g)||f.getInitialState()||(0,_immutable.Map)();
d._store=d._store.set(g,l),


d.setSessionData(d._name,d._store);
});else
{

var h=this._store.get(g)||f.getInitialState()||(0,_immutable.Map)();
this._store=this._store.set(g,h);
}


return this._storeClasses.get(g);
...
{
this._options=_immutable2.default.fromJS(c||{}),
...
var g=this._options.get('debugErrorFnc');
...
var g=this._options.get('debugInfoFnc');
...
var g=this._options.get('debugLogFnc');
...
{var d=this;return(
Array.isArray(c)?
c.map(function(e){return d._register(e)}):
