...
return this._storeClasses.get(d)||(this._storeClasses=this._storeClasses.set(d,c),this._useCache&&this.getSessionData(this._name).then(function(e){var f=_immutable.Map.isMap(e)?e:(0,_immutable.Map)(),g=_this4._store.get(d)||f.get(d)||_immutable2.default.fromJS(c.initialState())||(0,_immutable.Map)();_this4._store=_this4._store.set(d,g),_this4.setSessionData(_this4._name,_this4._store)})),this._storeClasses.get(d);
