...
b){var _this4=this;return(
Array.isArray(b)?
b.map(function(c){return _this4._register(c)}):
...
var c=b.constructor.toString().substr(0,5);

if('class'!==c&&'funct'!==c)
throw Error(b+' is not a class. Cannot register with Flux.');
...
return this._storeClasses.get(e)||(this._storeClasses=this._storeClasses.set(e,d),this._useCache&&this.getSessionData(this._name).then(function(f){var g=_immutable.Map.isMap(f)?f:(0,_immutable.Map)(),h=_this5._store.get(e)||g.get(e)||_immutable2.default.fromJS(d.initialState())||(0,_immutable.Map)();_this5._store=_this5._store.set(e,h),_this5.setSessionData(_this5._name,_this5._store)})),this._storeClasses.get(e);
...
_this6._deregister(c);
}):

this._deregister(b);

}},{key:'_deregister',value:function _deregister()
